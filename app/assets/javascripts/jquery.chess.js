(function($){
  ...
  function Chess(){
      ...
      this.init = function(options, elem){
          ...
          $pieces = {
                  wpawn: $piece.clone().addClass('wpawn'),
                  wrook: $piece.clone().addClass('wrook'),
                  wknight: $piece.clone().addClass('wknight'),
                  wbishop: $piece.clone().addClass('wbishop'),
                  wking: $piece.clone().addClass('wking'),
                  wqueen: $piece.clone().addClass('wqueen'),

                  bpawn: $piece.clone().addClass('bpawn'),
                  brook: $piece.clone().addClass('brook'),
                  bknight: $piece.clone().addClass('bknight'),
                  bbishop: $piece.clone().addClass('bbishop'),
                  bking: $piece.clone().addClass('bkking'),
                  bqueen: $piece.clone().addClass('bqueen')
                  };
